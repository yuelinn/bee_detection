...
round2-yolo-pred(+linn corrected) labelled honeybee: 6
round2-yolo-pred(+linn corrected) labelled bumblebee: 7
round2-yolo-pred(+linn corrected) labelled unknown_bee: 8
...
def main(hiwi_labels_dir, round_x_labels_dir, out_dir):
...
if __name__ == '__main__':
    ...
    main(hiwi_labels_dir, round_x_labels_dirs, out_dir)
